...
class ST7796SPI:
    ...
    def _init_sequence(self) -> None:
        ...
        d(0xC5, [0x18])
        time.sleep(0.12)
        d(0xE0, [0xF0, 0x09, 0x0B, 0x06, 0x04, 0x15, 0x2F, 0x54, 0x42, 0x3C, 0x17, 0x14, 0x18, 0x1B])
        d(0xE1, [0xE0, 0x09, 0x0B, 0x06, 0x04, 0x03, 0x2B, 0x43, 0x42, 0x3B, 0x16, 0x14, 0x17, 0x1B])
        time.sleep(0.12)
        d(0xF0, [0x3C])
        d(0xF0, [0x69])
        time.sleep(0.12)
